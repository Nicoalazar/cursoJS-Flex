...
/**
 * Displays a modal with the given title and message.
 *
...
function showErrorModal(title, message) {
    const modalTitle = document.querySelector('.errorModal-title');
    const modalBody = document.querySelector('.errorModal-body');
